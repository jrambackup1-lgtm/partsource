...
test('uncleared McMaster lookup fails closed without supplier handoff', async ({ page }) => {
  ...
  await expect(page.getByRole('heading', { level: 1 })).toHaveText('No supported configuration yet');
