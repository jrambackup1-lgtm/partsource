...
export function PartDetail() {
  ...
  useEffect(() => {
    ...
    if (partNumber) {
      ...
      const applyFoundItem = (foundItem: Part, state: PartResolution['state']) => {
      if (cancelled) return;
